defmodule Aletopelta.Year2023.Day17 do
  ...
  defmodule Common do
    ...
    defp search_path map, target, distances, priority, helpers do
      ...
      temp_helpers = case direction do
      ...
      case position do
        ...
        position ->
          {distances, priority} = get_available(direction)
    ...
    defp build_priority new_heat, {distances, priority} = acc, {position, direction, repetition} = key do
