defmodule Aletopelta.Year2023.Day10 do
  ...
  defmodule Part2 do
    ...
    def execute(input) do
      ...
      |> fill(MapSet.new(loop), {-1, 0}, {1, 0}, {MapSet.new(), MapSet.new()},
        outside: true,
        source: :west
      )
      |> elem(1)
    ...
    defp get_directions("F", delta, direction) do
      case {delta, direction} do
        {{1, 0}, :west} ->
          [{{1, 0}, [source: :north]}, {{0, 1}, [source: :west]}, {{0, -1}, [source: :south]}]

        {{-1, 0}, :south} ->
          [{{0, 1}, [source: :east]}]

        {{-1, 0}, :north} ->
          [{{-1, 0}, [source: :east]}, {{0, 1}, [source: :west]}, {{0, -1}, [source: :south]}]

        {{0, -1}, :west} ->
          [{{1, 0}, [source: :north]}, {{-1, 0}, [source: :east]}, {{0, -1}, [source: :south]}]

        {{0, -1}, :east} ->
          [{{1, 0}, [source: :south]}]

        {{0, 1}, :north} ->
          [{{1, 0}, [source: :north]}, {{-1, 0}, [source: :east]}, {{0, 1}, [source: :west]}]
      end
    end
    ...
    defp get_directions("7", delta, direction) do
      case {delta, direction} do
        {{1, 0}, :north} ->
          [{{1, 0}, [source: :west]}, {{0, 1}, [source: :east]}, {{0, -1}, [source: :south]}]

        {{1, 0}, :south} ->
          [{{0, 1}, [source: :west]}]

        {{-1, 0}, :east} ->
          [{{-1, 0}, [source: :north]}, {{0, 1}, [source: :east]}, {{0, -1}, [source: :south]}]

        {{0, -1}, :east} ->
          [{{1, 0}, [source: :west]}, {{-1, 0}, [source: :north]}, {{0, -1}, [source: :south]}]

        {{0, -1}, :west} ->
          [{{-1, 0}, [source: :south]}]

        {{0, 1}, :north} ->
          [{{1, 0}, [source: :west]}, {{-1, 0}, [source: :north]}, {{0, 1}, [source: :east]}]
      end
    end
    ...
    defp get_directions("J", delta, direction) do
      case {delta, direction} do
        {{0, 1}, :east} ->
          [{{1, 0}, [source: :west]}, {{-1, 0}, [source: :south]}, {{0, 1}, [source: :north]}]

        {{0, 1}, :west} ->
          [{{-1, 0}, [source: :north]}]

        {{1, 0}, :south} ->
          [{{1, 0}, [source: :west]}, {{0, 1}, [source: :north]}, {{0, -1}, [source: :east]}]

        {{1, 0}, :north} ->
          [{{0, -1}, [source: :west]}]

        {{-1, 0}, :east} ->
          [{{-1, 0}, [source: :south]}, {{0, 1}, [source: :north]}, {{0, -1}, [source: :east]}]

        {{0, -1}, :south} ->
          [{{1, 0}, [source: :west]}, {{-1, 0}, [source: :south]}, {{0, -1}, [source: :east]}]
      end
    end
    ...
    defp get_directions("L", delta, direction) do
      case {delta, direction} do
        {{0, -1}, :south} ->
          [{{1, 0}, [source: :south]}, {{-1, 0}, [source: :east]}, {{0, -1}, [source: :west]}]

        {{-1, 0}, :south} ->
          [{{-1, 0}, [source: :east]}, {{0, 1}, [source: :north]}, {{0, -1}, [source: :west]}]

        {{0, 1}, :west} ->
          [{{1, 0}, [source: :south]}, {{-1, 0}, [source: :east]}, {{0, 1}, [source: :north]}]

        {{1, 0}, :west} ->
          [{{1, 0}, [source: :south]}, {{0, 1}, [source: :north]}, {{0, -1}, [source: :west]}]
    ...
    defp calculate_line(delta, direction, list, is_empty?, build_tuple) do
      if is_empty?.(delta) and direction in list do
        ...
        {y, x} = build_tuple.(d)
        [{delta, [source: direction]}, {{x, y}, [source: other_direction]}]
      else
        [{build_tuple.(-1), [source: direction]}, {build_tuple.(1), [source: direction]}]
      end
    end
  end
end
